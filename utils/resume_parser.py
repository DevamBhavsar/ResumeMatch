...
class ResumeParser:
    ...
    def preprocess_text(self, text):
        ...
        try:
            ...
            text = re.sub(r'\+?[0-9]?[\s-]?\(?[0-9]{3}\)?[\s-]?[0-9]{3}[\s-]?[0-9]{4}', '', text)
    ...
    def extract_contact_info(self, text):
        ...
        try:
            doc = self.nlp(text[:100000] if len(text) > 100000 else text)  # Limit text size
    ...
    def process_resume(self, file_path):
        ...
        try:
            ...
            if not text:
                ...
                return {"text": "", "skills": [], "contact_info": {}, "experience": [], "education": [], "projects": []}
            ...
            contact_info = self.extract_contact_info(text)  # Use original text for contact info
