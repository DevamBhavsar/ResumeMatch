...
export function CoverLetterGenerator({ matchingSkills, missingSkills }: CoverLetterGeneratorProps) {
...
Based on my analysis, I have ${matchingSkills.length} of the key skills required for this position, including ${matchingSkills.slice(0, 5).join(", ")}${matchingSkills.length > 5 ? ", and others" : ""}.

${missingSkills.length > 0
  ? `While I am currently developing expertise in ${missingSkills.join(", ")}, my strong foundation in ${matchingSkills.slice(0, 3).join(", ")} provides me with the capability to quickly learn and apply these skills.`
