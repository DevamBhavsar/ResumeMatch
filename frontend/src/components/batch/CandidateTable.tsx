          ...
          <TableBody>
            {candidates.map((candidate) => (
              <TableRow key={candidate.resume_name}>
                <TableCell className="font-medium text-center">{candidate.rank}</TableCell>
                <TableCell>
                ...
                <TableCell className={getScoreColor(candidate.semantic_similarity)}>
            ...
            <div className="mt-4 space-y-6">
              <div className="flex flex-col md:flex-row gap-6 items-center">
                <div className="flex flex-col items-center">
                  ...
                  <ScoreCircle score={selectedCandidate.overall_score} size="lg" />
                </div>
                  ...
                  <div className="space-y-2">
                    <div className="space-y-1">
                      ...
                      <div className="h-2 bg-muted rounded-full overflow-hidden">
                        <div
                          className={`h-full ${getScoreColor(selectedCandidate.skill_match).replace('text-', 'bg-')}`}
                          style={{ width: `${selectedCandidate.skill_match}%` }}
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="h-2 bg-muted rounded-full overflow-hidden">
                        <div
                          className={`h-full ${getScoreColor(selectedCandidate.text_similarity).replace('text-', 'bg-')}`}
                          style={{ width: `${selectedCandidate.text_similarity}%` }}
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="h-2 bg-muted rounded-full overflow-hidden">
                        <div
                          className={`h-full ${getScoreColor(selectedCandidate.semantic_similarity).replace('text-', 'bg-')}`}
                          style={{ width: `${selectedCandidate.semantic_similarity}%` }}
                        />
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <SkillsList skills={selectedCandidate.matching_skills} type="matching" />
                </div>
                
                <div>
                  <h3 className="text-lg font-medium mb-2">Missing Skills</h3>
                  <SkillsList skills={selectedCandidate.missing_skills} type="missing" />
                </div>
              </div>
